    ...
    <footer className="bg-gradient-to-br from-white via-slate-100 to-gray-100 text-gray-800 py-10 mt-16 border-t border-gray-300">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center text-sm text-gray-600">
          <p>© 2025 <span className="text-green-600 font-semibold">Placement Portal</span>. All rights reserved.</p>
          <p className="mt-1 text-xs text-gray-500">Developed by MIND MATRIX</p>
        </div>
      </div>
    </footer>
  );
